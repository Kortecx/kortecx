...
import { fadeUp, fadeDown, fadeRight, stagger, tapScale, buttonHover } from '@/lib/motion';
    ...
    <div style={{ padding: 20, maxWidth: '100%', display: 'flex', flexDirection: 'column', height: 'calc(100vh - 48px)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexShrink: 0 }}>
        ...
        <motion.div variants={fadeRight} initial="hidden" animate="show" transition={{ delay: 0.15 }}
          ...
          <motion.button className="btn btn-secondary btn-sm" onClick={handleReset} {...tapScale}>
            <RotateCcw size={12} /> Reset
          </motion.button>
          <motion.button className="btn btn-primary btn-sm" onClick={handleSave} {...buttonHover}>
      ...
      <div style={{ display: 'flex', gap: 16, flex: 1, minHeight: 0 }}>
        ...
        <motion.div variants={stagger(0.04)} initial="hidden" animate="show"
          ...
          {CATEGORIES.map(c => {
            ...
            const Icon = c.icon;
            return (
              <motion.button key={c.id} variants={fadeUp} onClick={() => setCategory(c.id)} style={{
            ...
            >
              ...
              {category === 'inference' && (
                <motion.div variants={stagger(0.06)} initial="hidden" animate="show"
                  ...
                  <motion.div variants={fadeUp} style={{ borderTop: '1px solid var(--border)', paddingTop: 16 }}>
              ...
              {category === 'logging' && (
                <motion.div variants={stagger(0.06)} initial="hidden" animate="show"
                  ...
                  {settings.metricsCollectionEnabled && (
                    <motion.div variants={fadeUp} style={{ maxWidth: 200 }}>
              ...
              {category === 'notifications' && (
                <motion.div variants={stagger(0.06)} initial="hidden" animate="show"
                  ...
                  <motion.div variants={fadeUp} style={{ borderTop: '1px solid var(--border)', paddingTop: 14 }}>
              ...
              {category === 'security' && (
                <motion.div variants={stagger(0.06)} initial="hidden" animate="show"
                  ...
                  <motion.div variants={fadeUp} style={{ maxWidth: 300 }}>
                ...
                <motion.div variants={stagger(0.06)} initial="hidden" animate="show"
                  ...
                  {([
                    ...
                    <motion.div key={f.key} variants={fadeUp}>
                      <Toggle checked={settings.features[f.key]} onChange={v => updateFeature(f.key, v)} label={f.label} description={f.desc} />
                    </motion.div>
                  ))}
                </motion.div>
              )}
