...
//! Live witness — `#[ignore]` by default because it needs a REAL Discord bot
...
//! `kx serve` end-to-end, for the dual-engine gate — this smoke test just proves the connector
//! reaches Discord.
